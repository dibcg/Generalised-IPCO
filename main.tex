...
% \end{Question}
  ...
  \begin{theorem}\label{lem:cycle}
 	There is a function $f\colon \mathbb{N}\times \mathbb{N} \times \mathbb{N} \rightarrow \mathbb{N}$ such that a graph $G$  does not contain any $(a,b)$-quasi-isometric embedding of $C_k$ (or at least $C_k$) if and only if $G$ is quasi-isometric to a graph of girth at least $f(k,a,b)$.
 \end{theorem}
